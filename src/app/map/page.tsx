      ...
      <AnimatePresence>
        {showHint && (
          <motion.div
            ...
            className="absolute top-36 right-12 z-40 max-w-[400px] text-left pointer-events-none"
          >
            <p className="text-white/90 text-base leading-relaxed font-light drop-shadow-2xl tracking-wide">
