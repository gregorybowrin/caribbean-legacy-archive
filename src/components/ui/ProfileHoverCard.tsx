        ...
        >
          ...
          {data && (
            <div className="flex flex-col">
              <div className="h-40 w-full relative bg-sand/20 overflow-hidden border-b border-gold/10">
                {data.image_url ? (
              ...
              <div className="p-4">
                <h4 className="font-serif font-bold text-lg text-navy leading-tight mb-2">{data.name}</h4>
